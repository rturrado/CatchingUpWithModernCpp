...
export std::vector<int> read_vector_of_numbers_from_istream(std::istream& is)
{
    std::vector<int> v;
...
export std::vector<std::string> read_vector_of_strings_from_istream(std::istream& is)
{
