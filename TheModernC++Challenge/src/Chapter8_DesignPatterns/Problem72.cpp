...
std::ostream& operator<<(std::ostream& os, const FillLineStart& fill)
{
    std::fill_n(std::ostream_iterator<char>(os), fill.level, fill.value);
    return os;
}
...
struct Discount
{
    ...
    virtual [[nodiscard]] void print(std::ostream& os, FillLineStart fill_line_start = FillLineStart{}) const noexcept = 0;
...
struct ArticleFixedDiscount : public Discount
{
    ...
    virtual [[nodiscard]] void print(std::ostream& os, FillLineStart fill_line_start = FillLineStart{}) const noexcept override
    {
...
struct Article
{
    ...
    void print(std::ostream& os, FillLineStart fill_line_start = FillLineStart{}) const noexcept
    {
