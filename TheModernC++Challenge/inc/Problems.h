...
private:
    ...
    std::vector<FunctionType> data_{
        ...
        problem_45_main, problem_46_main, problem_47_main, problem_48_main, problem_49_main, problem_50_main, problem_51_main, problem_52_main  // Algorithms and data structures
    };
};
